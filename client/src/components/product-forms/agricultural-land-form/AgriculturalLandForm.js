...
import "./Agricultural-LandForm.css";
...
const AgriculturalLandForm = ({ auth, setAuth }) => {
  //set property type
  // message to login
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      const response = await axios.post("/agri-land-form", data, {
        headers: {
          authorization: token,
        },
      });
        ...
        <main className="land-form-container">
          ...
          >
            <AccordionSummary
              ...
              id="panel1d-header"
            >
              <Typography>Agricultural Land Details</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <PropertyDetails
