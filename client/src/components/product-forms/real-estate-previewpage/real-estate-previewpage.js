...
import AdditionalInfo from '../apartment-form/propertyFormSteps/AdditionalInfo';

const RealEstatePreviewPage = ({ propertyData, locality, images, aminities, additionalDetails, handleClose, handleUploadImages }) => {
    ...
    return (
        <div className="real-estate-form-preview-wrapper">
            ...
            <h4>
                ...
                {locality?.street}, {locality?.landmark}, {locality?.city}, {locality?.pin}, {locality?.state}
            </h4>
            <div className="villa-details-table">
                ...
                <section>
                    <p>Property Age</p>
                    <p className="villa-details-table-value">{propertyData.propertyAge}</p>
                </section>
                ...
                <section>
                    <p>Total Shares</p>
                    <p className="villa-details-table-value">{propertyData.totalShares}</p>
                </section>
                <p className="villa-details-table-dummy-border"></p>
                <section>
                    <p>Available Shares</p>
                    <p className="villa-details-table-value">{propertyData.availableShares}</p>
                </section>
                <p className="villa-details-table-dummy-border"></p>
                <section>
                    <p>Price Per Share</p>
                    <p className="villa-details-table-value">{propertyData.perSharePrice}</p>
                </section>
            </div>
            ...
            <div className='preview-property-post-btn-wrapper'>
                <button className='preview-property-post-btn' onClick={handleUploadImages}>
                    POST
                </button>
            </div>
        </div>
