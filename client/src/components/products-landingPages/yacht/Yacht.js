    ...
    <div className='product-landingpage-wrapper'>
      ...
      <div className='yacht-r1-container'>
        <div className="yacht-content-container">
          ...
          <p>Nullam at mauris non elit auctor ullamcorper. Phasellus efficitur risus nec semper tincidunt. Nam sit amet mauris ullamcorper, lobortis justo id, consectetur ipsum. Suspendisse pulvinar auctor purus, ut facilisis tellus iaculis nec.</p>
          <p>
            <button>Contact Us</button>
          </p>
        </div>
        <div className="yacht-image-container">
          <img src="https://seastyle.net/wp-content/uploads/2023/05/Lagoon-Sixty5-Homepage.jpg" alt="Your Image" />
        </div>
      </div>
      <div className='yacht-faq-contact-container'>
        <section className='yacht-fc-lb'>
          <p>
            <img src='https://seastyle.net/wp-content/uploads/2022/07/faq.jpg' alt='yacht-img-lb' />
          </p>
          <p>
            We are sure you have questions, visit our FAQ page for some quick answers.
        ...
        <section className='yacht-fc-rb'>
          <p>
            <img src='https://seastyle.net/wp-content/uploads/2022/07/mouillage-lifestyle-ncz10198-a3-1-1.jpg' alt='yacht-img-rb' />
          </p>
          <p>
            We are sure you have questions, visit our FAQ page for some quick answers.
            Or contact us for more information!
